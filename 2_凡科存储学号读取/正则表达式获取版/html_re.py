...
html = html.find('div',class_="fk-editor simpleText fk-editor-break-word ")
#print(html.text)


soup = str(html)
soup = re.findall('>.+38',soup)
#print(str(soup))
soup = re.split("\['>|'\]|<div>|</div><div>",str(soup))
soup.pop(0)
soup.pop(-1)
print(soup)
