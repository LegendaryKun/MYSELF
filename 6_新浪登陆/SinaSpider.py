...
import json
import requests
#import cookielib  //python 3.6 改成 http.cookiejar了
from http import cookiejar
import urllib
#import urllib2    //urllib2 在 python3.x 中被改为urllib.request
import urllib.request
import gzip
#import StringIO  //在python3.x中，StringIO已经在io模块中了
...
def testLogin():
    client = SinaClient()
    #username = raw_input("Please input username: ")     #2.几版本input
    #username = input("Please input username: ")  
    #password = getpass.getpass("Please input your password: ")  #无回显输入密码
    username = '17865570232'
    password = 'wb1324'
    ...
    client.output(follow, "F:/Python/program/info2.html")
...
def testLogin2():
    ...
    client.output(info, "F:/Python/program/info2.html")
